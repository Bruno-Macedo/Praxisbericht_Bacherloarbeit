...
\begin{table}[H]
    ...
    10 - 12      &  Start, Durchführung und Abschluss eines neuen Pentesting-Projekts an Netzwerk-Umgebungen mit dem obigen beschriebenen Schritte (\ref{Projektablauf}). Die durchgeführten Tests konzentrieren sich auf die Sicherheit einer Netzwerk. Für dieses Projekt spielt das Tool gls{nmap} eine wichtige Rolle, da das Ziel war, Hosts, Dienst und dessen \gls{Schwachstelle} zu erkennen \\
