...
Aus dieser Abfrage ermitteln wir die Anzahl der fehlgeschlagenen Anmeldeversuche pro IP-Adresse. Mit einem Zeitfenster von einer Woche lösen wir eine Meldung aus, wenn diese Anzahl den Wert 50 überschreitet. Diese Schwelle haben wir gemäß der Empfehlung von \cite{NIST_Passwort} festgelegt.
