...
Promtail sucht automatisch und in vordefinierten Zeitabständen nach Logdateien, die in der Konfigurationsdatei eingetragen wurden. Die \quotes{labels} und den Zeitstempel werden in dem jeweiligen Abschnitt definiert.
