...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.8\textwidth]{assets/2_p6.png}
   \caption{Architekturdiagram von AlienVaulkt \gls{USM} \\Quelle: \citep{ATT_AVO} }
   \centering
\end{figure}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.8\textwidth]{assets/2_p7.png}
