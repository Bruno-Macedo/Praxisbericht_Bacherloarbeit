...
\newglossaryentry{container} {
    name={Container},
    plural={Containers},
    description={funktionieren ähnlich wie virtuelle Maschinen (VMs), jedoch werden Container auf der Ebene der Betriebssystemvirtualisierung erstellt und ausgeführt, während VMs eine komplette virtuelle Hardwareumgebung emulieren. Container werden oft für einzelne Anwendungen verwendet und teilen Ressourcen wie den Kernel des Host-Betriebssystems. Jeder Container ist in einer isolierten Umgebung mit den notwendigen Ressourcen für den Betrieb der ausgewählten Anwendung. Docker ist eine der bekanntesten Plattformen zur Verwaltung von Containern \citep{Douglis_Container}}}
...
\newglossaryentry{hash} {
    name={Hashwerte},
    plural={Hashwerte},
    description={sind Zeichenfolgen, die durch Anwenden einer mathematischen Funktion (Hashfunktion) auf einen Text oder eine Datei erzeugt werden. Die Rückführung auf das ursprüngliche Objekt aus dem Hashwert sollte jedoch schwierig sein \citep{Wendzel_IS}}}
...
\newglossaryentry{KI2}{
    ...
    description={bezieht sich darauf, dass Maschinen in der Lage sind, menschenähnliche kognitive Fähigkeiten wie Verständnis, Entscheidungsfindung, Lernen und Problemlösung zu entwickeln \citep{Collins_KI}}}
% here goes to the acronym
\newglossaryentry{KI}{
    type=\acronymtype,
    name=KI,
...
\newglossaryentry{polyphomicMalware} {
    ...
    description={sind Schadprogramme, deren Erkennungsregeln sich an die Umgebung anpassen, um nicht von Anti-Malware-Systemen erkannt zu werden \citep{Syuhada_Polymorphic}}   
    }
...
\newglossaryentry{port} {
    name={Port},
    plural={Ports},
    description={ist eine numerische Identifikation eines Dienstes oder einer Verbindung. Es handelt sich um eine logische Adressierung, die zur Identifikation eines oder mehrerer Prozesse verwendet wird \citep{Tanembaum_CN}}}
...
\newglossaryentry{usecases} {
    name={Use Cases},
    plural={Uses Cases},
    description={Use Cases beschreiben die Interaktionen zwischen Systemen und Benutzern. Sie dienen der Anforderungserhebung für ein System \citep{Savic_UseCase}}}
...
\newglossaryentry{vm2}{
    ...
    description={ist eine Kopie der Hardware-Struktur mit einer eigenen Aufteilung von Ressourcen und einem eigenen Betriebssystem. Auf einer physischen Maschine, auch Host genannt, können mehrere solcher VMs ausgeführt werden. Sie emulieren ein echtes und unabhängiges System \citep{Tanembaum_MBS}}}
...
\newglossaryentry{webhook} {
    name={Webhook},
    plural={Webhooks},
    description={Webhooks funktionieren ähnlich wie APIs, ohne dass die Client-Seite ständig nach Aktualisierungen fragen muss. Bei Webhooks sendet der Server die Aktualisierung, sobald sie verfügbar ist. Die Kommunikation findet in Echtzeit statt \citep{Tas_webhook}}}
