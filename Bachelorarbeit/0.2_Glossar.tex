...
\newglossaryentry{polyphomicMalware} {
    ...
    description={sind Schadsoftware, deren Erkennungsregel (Signature) sich an der Umgebung anpassen, um von Anti-Malware Systemen nicht erkannt werden \citep{Syuhada}}   
    }
