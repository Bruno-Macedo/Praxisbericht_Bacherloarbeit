...
\newglossaryentry{API}{
    ...
    description=\glslink{API2}{Application Programming Interface (API)}}
% =====

\newglossaryentry{backend} {
    name={Backend},
    description={bezieht sich auf Elementen, mit denen die Benutzer keinen direkten Kontakt haben, wie Server und Database\citep{at_query}}}
...
\newglossaryentry{CIA2}{
    name=\glslink{CIA}{Vertraulichkeit, Integrität und Verfügbarkeit (\gls{CIA})},
    description={ (Confidentiality, Integrity and Availability im Original)beschreiben die drei wichtigsten Schutzziele der IT-Sicherheit: Vertraulichkeit, Integrität und Verfügbarkeit \citep{Wendzel_IS}}}
...
\newglossaryentry{DLS2}{
    name=\glslink{DSL}{Domain Specific Language (\gls{DSL})},
    description={Abfragesprache von Elasticsearch für die Kommunikation mit der Databank. Diese Abfragesprache hat zwei verschiedene Typen: \quotes{Leaf} für die Suche nach spezifischen Mustern und \quotes{Compound} für die logische Kombination von mehrere Abfragen \citep{elastic_DSL}}}

\newglossaryentry{DSL}{
    type=\acronymtype,
    name=DSL,
    first={Query Domain Specific Language (Query DSL) \glsadd{DLS2}},
    see=[Glossary:]{\gls{DLS2}}, 
    description=\glslink{DLS2}{Query Domain Specific Language}}
% =====
...
\newglossaryentry{fail2ban} {
    name={Fail2ban},
    description={ist ein Intrusion Prevetion Tool, das gegen Brute-Force Angriffe schützt, indem Logdateien analyisiert und verdächtige IP-Adresse blockiert.\citep{Fail2ban}}   
}
...
\newglossaryentry{frontend} {
    name={Frontend},
    description={bezieht sich auf die Benutzeroberfläche und die Elemente, mit denen die Benutzer direkt interagieren \citep{at_query}}}
...
\newglossaryentry{GUI2}{
    ...
    description={ - Es handelt sich dabei um eine visuelle Schnittstelle, die es dem Benutzer ermöglicht, mit Anwendungen mittels Symbole und grafischen Elementen zu interagieren. Im Gegensatz dazu verwendet die textbasierte Benutzeroberfläche (CLI) Befehlszeilen und Texteingabe zur Steuerung von Anwendungen \citep{Fu_GUI}}}
...
% here goes to the description
\newglossaryentry{json2}{
    name=\glslink{json}{JavaScript Object Notation (\gls{json})},
    description={ist eine Standard text-basierte Dateiformat, die von Menschen leicht zu verstehen ist und von Maschine einfach zu analysieren und strukturieren (parsen). Es ist eine Untermenge der JavaScript Programmiersprache \citep{Json_Json}}}

% here goes to the acronym
\newglossaryentry{json}{
    type=\acronymtype,
    name=JSON,
    first={JavaScript Object Notation (JSON)\glsadd{json2}},
    see=[Glossary:]{\gls{json2}}, 
    description=\glslink{json2}{JavaScript Object Notation }}
% =====
...
\newglossaryentry{pillarobservability} {
    name={Log- und Messdaten und Ablaufverfolgung},
    description={sind drei große Datenquelle für die Überwachung eines Systems und spiele eine wesentliche Rolle in der Beobachtbarkeit. Logdateien speichern Ereignisse oder Aktionen, die in einem System stattfinden. Messdaten zeigen quantifizierte Daten, wie Aufnahmerate oder Anzahl von verwendeten Resource. Ablaufverfolgung beschäftigt sich mit dem Informationsfluss bei der Ausführung einer Anwendung  \citep{Tozzi_Pillars}}}
...
\newglossaryentry{stuffing} {
    ...
    description={ist ein Angriff gegen Passwörter, indem bekannte Anmeldedaten von vorherigen Angriffen verwendet werden. Dieser Angriff basiert sich auf die Idee, dass Nutzer dasselbe Passwort für verschiedenen Systemen verwenden \citep{Nguyen_stuffing}}}
