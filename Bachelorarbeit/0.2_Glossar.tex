...
\newglossaryentry{frontend} {
    name={Frontend},
    description={bezieht sich auf die Benutzeroberfläche und die Elementen, mit denen die Benutzer direkt interagieren \citep{at_query}}}

\newglossaryentry{backend} {
    name={Backend},
    description={bezieht sich auf Elementen, mit denen die Benutzer keine direkte Kontakt haben, wie Server und Database\citep{at_query}}}
...
\newglossaryentry{DLS2}{
    name=\glslink{DSL}{Query Domain Specific Language (\gls{DSL})},
    description={Abfragesprache von Elasticsearch für die Kommunikation mit der Databank. Diese Abfragesprache hat zwei verschiedene Typen: \quotes{Leaf} für die Suche nach spezifischen Muster und \quotes{Compound} für die logische Kombination von mehrere Abfrage \citep{elastic_DSL}}}
