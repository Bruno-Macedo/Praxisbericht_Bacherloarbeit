...
\newglossaryentry{stuffing} {
    ...
    description={ist ein Angriff gegen Passwörten, indem schon bekannte Anmeldedaten von vorherigen Angriffen verwendet werden. Dieser Angriff basiert sich auf die Idee, dass Nutzer dasselbe Passwort für verschiedenen Systemen verwenden \citep{Nguyen_stuffing}}}
...
\newglossaryentry{rockyou} {
    name={Rockyou},
    description={ist eine Textdatei mit über 8 Millarden Passwörter im Klartext. Diese Datei entstammt aus einem im Jahr 2009 stattgefundenen Angriff gegen Yahoo und ist seitdem ständig aktualisiert \citep{Mikalauskas_rockyou}}}
...
\newglossaryentry{vm2}{
    ...
    description={ist eine Kopie der Hardware-Struktur mit eigenen Aufteilung von Resources und mit eigenen Betriebssystem. In einer physikalischen Maschine, auch Host virtuelle Maschine genannt, kann mehreren von solchen VMs laufen. Sie emulieren ein echtes und unabhängiges System \citep{Tanembaum_MBS}}}
