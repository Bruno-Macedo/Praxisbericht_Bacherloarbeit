...
\newglossaryentry{IT-Sicherheitsgesetz 2.0} {
    ...
    description={ein im Jahr 2021 verabschiedetes Bundesgesetz zur Erhöhung von Sicherheit informationstechnischen Systemen besonders, solchen von den kritischen Infrastrukturen  \citep{Harmes_ITSG}}
}
...
\newglossaryentry{GUI2}{
    ...
    description={eine Schnitstelle, die den Nutzer ermöglicht, mithilfe von Symbolen und visuellen Elementen mit der Anwendung zu interagieren \citep{Fu_GUI}}
}
...
\newglossaryentry{NOC2}{
    ...
    description={zentraliserter Bereich eines Unternehmens dafür zuständig, Netzwerkaktivitäten zu überwachen und zu verwalten \citep{Mohammed_NOC} }
}
\newglossaryentry{NOC}{
    type=\acronymtype,
    name=NOC,
